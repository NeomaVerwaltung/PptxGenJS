...
The PptxGenJS interfaces referenced in surrounding documentation. See the [complete list](https://github.com/NeomaVerwaltung/PptxGenJS/blob/master/types/index.d.ts) on GitHub.
