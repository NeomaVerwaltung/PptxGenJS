 ...
 *
 * Agents get overlap and off-slide content wrong because `addX` takes absolute
 * inches. A grid removes the arithmetic and throws on out-of-range spans
 * instead of silently placing content past the slide edge.
 *
 * @example
