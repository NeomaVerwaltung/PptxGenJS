...
import type pptxgen from '../../core/src/pptxgen'
...
export const packageZip = async (pptx: pptxgen): Promise<JSZip> =>
...
export const chartXml = async (pptx: pptxgen): Promise<string> => {
