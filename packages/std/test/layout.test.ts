/** Contracts for `@neo-ma/pptxgenjs-std/layout` - pure arithmetic, asserted directly. */
...
test('grid: spans absorb the gutters they cross', () => {
	...
	const one = at(0, 0)
	const two = at(0, 0, 2)
	// A 2-column span is two cells plus the gutter between them, not two bare cells.
