 ...
 */
/**
 * Zoom-object namespaces (MS-PPTX 2.2.15)
...
export const ZOOM_NS = {
	...
	zmPr: 'http://schemas.microsoft.com/office/powerpoint/2016/6/main',
} as const
...
export const DEF_SHAPE_SHADOW = { type: 'outer', blur: 3, offset: 23000 / 12700, angle: 90, color: '000000', opacity: 0.35, rotateWithShape: true } satisfies Required<Omit<ShadowProps, 'preset'>>
...
/**
 * 1x1 transparent PNG
 * - used as the default zoom cover: PowerPoint replaces it with a live thumbnail of the zoom target
 *   on open, so shipping a real image would only add bytes
 */
export const IMG_BLANK = 'image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAC0lEQVR42mNkAAIAAAoAAv/lxKUAAAAASUVORK5CYII='
